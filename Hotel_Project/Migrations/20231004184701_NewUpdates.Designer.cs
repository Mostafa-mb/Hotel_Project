...
namespace Hotel_Project.Migrations
{
    ...
    [Migration("20231004184701_NewUpdates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.OrderReserveDate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.Order", b =>
                {
                    b.HasOne("Hotel_Project.Models.Entities.Account.User", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Hotel_Project.Models.Basket.Order", null)
                        .WithMany("orderDetails")
            ...
            modelBuilder.Entity("Hotel_Project.Models.Basket.OrderReserveDate", b =>
                {
                    b.HasOne("Hotel_Project.Models.Basket.OrderDetail", "orderDetail")
